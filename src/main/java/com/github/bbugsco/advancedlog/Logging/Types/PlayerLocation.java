...
public class PlayerLocation extends LogEntry {
    ...
    // Construct from log
    public PlayerLocation(String log) {
        super(LogType.PLAYER_LOCATION.getID(), Long.getLong(log.split(",")[0]));
    ...
    public PlayerLocation(String username, Location location) {
        super(LogType.PLAYER_LOCATION.getID(), System.currentTimeMillis());
